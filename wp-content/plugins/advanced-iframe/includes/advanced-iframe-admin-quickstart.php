...
printQuickstartGuide();
  ...
  echo '<table class="form-table hide-print">';
      ...
      printTextInput(false,$devOptions, __('Editor button', 'advanced-iframe'), 'editorbutton', __('With this setting you can add a "advanced iframe" button to the text editor of Wordpress. The button does add the shortcode with the current security code + the settings you define. You can use any setting from the administration. Be default securitykey,src,width,height is used. The securitykey is always rendered. If you leave this setting empty the button is not shown.', 'advanced-iframe')); 
