...
$current_user = wp_get_current_user();
 ...
 $usermeta_html .= '</span>';
        ...
        printTextInput(false,$devOptions, __('<b>Url</b>', 'advanced-iframe'), 'src', $src_text, 'text', 'http://www.tinywebgallery.com/blog/advanced-iframe/advanced-iframe-pro-demo/url-features');
?>
      <tr>
