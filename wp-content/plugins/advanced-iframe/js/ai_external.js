 ...
 *  Created: 2018-02-23 09:07:25  
*/ 

var domain_advanced_iframe = 'http://192.168.3.88/bit/wp-content/plugins/advanced-iframe'; // Check if this is your wordpress directory of ai
...
window.jQuery || document.write("<script src='http://192.168.3.88/bit/wp-includes/js/jquery/jquery.js'></script>")
...
function aiExecuteWorkaround_advanced_iframe() {
    if (window!=window.top) { /* I'm in a frame! */ 
      ...
      if (updateIframeHeight == 'true') { 
        ...
        // add the iframe dynamically
        var url = domain_advanced_iframe + '/js/iframe_show.html?id='+ iframe_id_advanced_iframe;
